...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        navViewController.navigationBar.barTintColor                     = UIColor(named: "mainColorTheme")
        navViewController.navigationBar.backIndicatorImage               = image
        navViewController.navigationBar.backIndicatorTransitionMaskImage = image
        navViewController.navigationBar.backItem?.title                  = ""
